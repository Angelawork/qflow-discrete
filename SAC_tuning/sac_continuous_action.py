...
def make_env(env_id, seed, idx, capture_video, run_name,step_list=[1500000]):
    def thunk():
...
"""
    ...
    args = tyro.cli(Args)
    run_name = f"{args.env_id}__{args.target_entropy}__{args.exp_name}__{args.seed}__{int(time.time())}"
